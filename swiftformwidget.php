...
function swift_scroll_popup() {
    ...
    //Return if not enabled
    if (!$swift_settings['enable_scroll'])
        return;
    ...
    <span id="scroll_aware_init" style="opacity:0; position:absolute; left: 0; bottom:0px; height:0px;">&nbsp;</span>
    <!-- This file is used to markup the public facing aspect of the plugin. -->
